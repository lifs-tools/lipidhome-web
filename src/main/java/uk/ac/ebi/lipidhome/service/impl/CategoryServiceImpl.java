 ...
 *
 * The CategoryServiceImpl contains all the logic for fulfilling the methods
 * defined in the CategoryService Interface
 *
 */
public class CategoryServiceImpl extends LipidService implements CategoryService {
    ...
    /**
     *
     * @param id The database id of the category of interest A Category Object
     * is built and from it a CategorySummary is built. This object is
     * transformed to json via the result2Response method in LipidService and
    ...
    /**
     *
     * A List of Category Objects is built on request by the CategoryDao. This
     * is transformed into something that inherits LipidObject and can then be
     * transfromed into a Response. This si used to intially populate the
     * Hierarchy Panel.
     *
    ...
    /**
     *
     * A List of SimpleMainClass Objects is built on request by the CategoryDao.
     * Once converted into a Result object by the ListConverter it can be
     * transformed into a Response object that contains the simpleMainClass list
     * encoded as a json string.
     *
     * @return A response object containing a json formatted List of
     * SimpleMainClasses.
     */
    @Override
